...
namespace App\Services\SubjectClassroom;

use App\DTOs\PaginatedResult;
use App\Enums\ResponseStatus;
use App\Exceptions\ApiException;
use App\Http\Resources\SubjectClassroom\HomeworkAssignmentResource;
use App\Http\Resources\SubjectClassroom\HomeworkSubmissionResource;
use App\Http\Resources\SubjectClassroom\SubjectClassroomOptionsResource;
use App\Http\Resources\SubjectClassroom\SubjectLessonResource;
...
class SubjectClassroomService
{
    ...
    public function options(Request $request)
    {
        ...
        return $this->success(new SubjectClassroomOptionsResource([
            'scope' => $actor['scope'],
    ...
    public function lessons(Request $request)
    {
        ...
        return $this->success(PaginatedResult::fromPaginator($paginated, SubjectLessonResource::class), 'Lessons retrieved successfully.');
    }
    ...
    public function storeLesson(Request $request)
    {
        ...
        return $this->success(new SubjectLessonResource($lesson), 'Lesson uploaded successfully.');
    }
    ...
    public function homework(Request $request)
    {
        ...
        return $this->success(
            PaginatedResult::fromPaginator($paginated, HomeworkAssignmentResource::class),
    ...
    public function storeHomework(Request $request)
    {
        ...
        return $this->success(new HomeworkAssignmentResource($homework), "{$assessmentConfig['label']} created successfully.");
    }
    ...
    public function updateHomework(Request $request, $id)
    {
        ...
        return $this->success(new HomeworkAssignmentResource($homework), "{$assessmentConfig['label']} updated successfully.");
    }
    ...
    public function submissions($id)
    {
        ...
        return $this->success([
            ...
            'submissions' => HomeworkSubmissionResource::collection($subs),
    ...
    public function submitHomework(Request $request, $id)
    {
        ...
        return $this->success(
            new HomeworkSubmissionResource($submission),
            $existing
    ...
    public function gradeSubmission(Request $request, $id)
    {
        ...
        return $this->success(new HomeworkSubmissionResource($submission), "{$assessmentConfig['label']} submission graded successfully.");
    }
    ...
    public function reviewSubmission(Request $request, $id)
    {
        ...
        if (!$this->supportsHomeworkReviewState()) {
            $submission->load('student:id,full_name_en,full_name_kh');
            return $this->success(new HomeworkSubmissionResource($submission), 'Submission review tracking is not available until the database migration is applied.');
        }
        ...
        return $this->success(new HomeworkSubmissionResource($submission), 'Submission marked as reviewed.');
    }
