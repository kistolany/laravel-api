...
use App\Http\Requests\Api\V1\MajorSubjectRequest; // Correct Request
use App\Http\Resources\Api\V1\MajorSubjectResource; // Correct Resource
...
class MajorSubjectController extends Controller
{
    ...
    public function __construct(
        protected Major_subject_service $service // Injecting the right service
    ) {}
