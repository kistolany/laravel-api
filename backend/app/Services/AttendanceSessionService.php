...
use App\Http\Resources\AttendanceRecordBulkResource;
use App\Http\Resources\AttendanceSessionCreateResource;
use App\Http\Resources\AttendanceSessionDetailResource;
...
class AttendanceSessionService
{
    ...
    private function recordAttendanceForSession(AttendanceSession $session, array $data): array
    {
        ...
        $dto = new AttendanceRecordBulkResult($sessionId, count($rows));
